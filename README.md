...
## 📋 목차
1. [초기 제작 프롬프트](#초기-제작-프롬프트)  
2. [애플리케이션 개요](#애플리케이션-개요)  
3. [도메인(업종)별 시나리오](#도메인업종별-시나리오)  
4. [컴포넌트 사양서](#컴포넌트-사양서)  
5. [데이터 구조](#데이터-구조)  
6. [업무 흐름 & 모드 로직](#업무-흐름--모드-로직)  
7. [디자인 시스템 & 접근성](#디자인-시스템--접근성)  
8. [테스트 시나리오](#테스트-시나리오)  
9. [설치 & 실행](#설치--실행)  
10. [개선 프롬프트 예시](#개선-프롬프트-예시)  
11. [로드맵](#로드맵)  
12. [프로젝트 맥락](#프로젝트-맥락)
